...
class WorkflowPolicyTests(unittest.TestCase):
    ...
    def test_source_is_pinned_and_stable_builds_use_release_mode(self) -> None:
        ...
        self.assertIn("source_commit", package)
    ...
    def test_policy_workflow_covers_all_maintenance_surfaces(self) -> None:
        ...
        expected = {
            "*.md", "docs/**", "deps/**", "Containerfile", "build.sh",
            "test.sh", "scripts/**", "tests/**", ".gitattributes",
            ".gitignore", ".mailmap", ".githooks/**", ".github/actions/**",
            ".github/workflows/**", ".github/dependabot.yml", "LICENSE",
        }
    ...
    def test_documentation_avoids_known_drift_sources(self) -> None:
        documentation = [REPO / "README.md", REPO / "RELEASING.md", REPO / "SECURITY.md", *(REPO / "docs").glob("*.md")]
