...
- Official-resource audit cleanup: aligned `docs/build-plan.md` with the actual `build.sh` Makefile-wrapper build path and fixed `docs/reproducibility.md` ARM filename/metadata wording (`nvim-linux-aarch64.deb` filename, `arm64` Debian metadata).
